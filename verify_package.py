...
required=[
    ...
    'styles.v2.5.8.css','platform.v2.5.8.js','app.v2.5.8.js',
    'sw.js','manifest.webmanifest','README.md','UPDATE_AND_MIGRATION_POLICY.md',
    'UPLOAD_v2.5.8.md','EDGE_FUNCTIONS_SETUP.md','render.yaml','VERSION.json',
...
if '"appVersion": "2.5.8"' not in version or '"cloudMigrationVersion": 12' not in version or "teryaq-master-tool-v2.5.8" not in (root/'sw.js').read_text(encoding='utf-8'):
    print('VERSION/CACHE MISMATCH: expected v2.5.8 / migration 12');sys.exit(1)
for source,versioned in [('app.js','app.v2.5.8.js'),('platform.js','platform.v2.5.8.js'),('styles.css','styles.v2.5.8.css')]:
    if (root/source).read_bytes()!=(root/versioned).read_bytes():
        print('STALE VERSIONED ASSET:',versioned);sys.exit(1)
for ref in ['styles.v2.5.8.css','platform.v2.5.8.js','app.v2.5.8.js','vendor/jszip.min.js']:
    if ref not in html:
