const CACHE = 'teryaq-master-tool-v2.4.6';
...
const CORE_ASSETS = [
  ROOT_URL,
  APP_SHELL_URL,
  new URL('styles.v2.4.6.css', SCOPE_URL).href,
  new URL('platform.v2.4.6.js', SCOPE_URL).href,
  new URL('app.v2.4.6.js', SCOPE_URL).href,
