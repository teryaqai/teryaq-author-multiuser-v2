const CACHE = 'teryaq-master-tool-v2.5.8-editor-table-outline-icons-1';
...
const CORE_ASSETS = [
  ROOT_URL,
  APP_SHELL_URL,
  new URL('styles.v2.5.8.css', SCOPE_URL).href,
  new URL('platform.v2.5.8.js', SCOPE_URL).href,
  new URL('app.v2.5.8.js', SCOPE_URL).href,
