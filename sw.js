const CACHE = 'teryaq-master-tool-v2.5.7-ribbon-update-read-sync-icon-1';
...
const CORE_ASSETS = [
  ROOT_URL,
  APP_SHELL_URL,
  new URL('styles.v2.5.7.css', SCOPE_URL).href,
  new URL('platform.v2.5.7.js', SCOPE_URL).href,
  new URL('app.v2.5.7.js', SCOPE_URL).href,
